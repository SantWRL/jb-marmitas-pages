...
export default function FoodDetail() {
  ...
  const effectivePrice = food.promo_price && food.promo_price > 0 ? food.promo_price : food.price;
    ...
    <DefaultPage>
      <Wrapper className="overflow-hidden px-0">
        ...
        <section className="flex w-full flex-col gap-8 tablet:gap-10 desktop_md:mb-10 desktop_md:flex-row desktop_md:gap-11">
          <h1 className="text-5xl font-bold text-white desktop_md:hidden">{food.title}</h1>
          ...
          <div className="mb-8 flex w-full flex-col gap-5 tablet:mb-11 tablet:gap-10 desktop_md:mb-0 desktop_md:gap-10">
            <h1 className="hidden text-5xl font-bold text-white desktop_md:block">
              {food.title}
            </h1>
            ...
            <div className="flex w-full flex-wrap items-center justify-start gap-5 font-josefinSans tracking-normal tablet:justify-center tablet:gap-8 desktop_md:justify-between">
              <div
                className={clsx(
                  ...
                  {
                    ["bg-red text-white"]: food.category.label === "Massas",
                    ["bg-dark text-white"]: food.category.label === "Carnes",
                    ["bg-combos"]: food.category.label === "Combos",
                    ["bg-veganos"]: food.category.label === "Veganos",
                  }
                )}
              >
                {food.category.label}
              </div>
              <div className="flex items-center justify-center text-xl font-bold text-white desktop_md:text-2xl">
                {food.size}g
              </div>
              <div className="flex items-center justify-center text-xl font-bold text-white desktop_md:text-2xl">
